...
// гитхаб или  дискорд или еще чтото

// стили и адаптив  // Админка. блокировать юзера? таблицы адаптив
// продумать иконку лайков
// сделать еще 1 авторизацию

//  ??? как хранить тему ???
// оптимизировать бек, раскидать переменные, поиск по тегам(опционально)
